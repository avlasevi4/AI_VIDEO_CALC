...
assert.match(html, /js\/app\.js\?v=3\.7\.0/, 'release scripts bypass a stale PWA asset cache');
assert.match(html, /css\/app\.css\?v=3\.7\.0/, 'release styles bypass a stale PWA asset cache');
